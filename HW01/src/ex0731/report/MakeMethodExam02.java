...
*/
	 private int methodExam02_01(int num1, int num2) {
		 ...
		 if ((num1 + num2) % 3 == 0) System.out.println("3의 배수");
		 return num1 + num2;
	 }
...
/*	Method 이름 : methodExam02_02
	...
	Return Type : String
	Parameter : String	
	(구현부에서)하는일 : 인수로 받은(들어온) String 에 바보를 붙여서 출력
			     인수로 받은 (들어온)String 에 바보를 붙여서 리턴
*/
	 public String methodExam02_02(String str) {
		 System.err.println(str + "바보");
		 return str + "바보";
	 }
...
/*	
	...
	(구현부에서)하는일 : 인수로 받은 정수와 String 을 (하나의 String 으로) 붙여서 출력
...
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	 protected double methodExam02_04(int n1, double d1, int n2) {
		 System.out.println(n1 * d1 - n2);
		 return n1 * d1 - n2;
	 }
	...
	public static void main(String [] args){
      ...
      String s = mme.methodExam02_02("이은진");
