...
import WS_07_Exception.com.ws07.dto.InstallAccountDto;
import WS_07_Exception.com.ws07.dto.LoanAccountDto;
import WS_07_Exception.com.ws07.dto.SavingAccountDto;
...
public class BankServiceImpl implements BankService {
	...
	public AccountDto getUserAccount(int userSeq, int accountSeq) throws UserAccountNotFoundException {
		List<AccountDto> accountList = getAccountList(userSeq);
		
		for (AccountDto account : accountList) {
			if (account.getAccountSeq() == accountSeq) {
				return account;
			}
		}
