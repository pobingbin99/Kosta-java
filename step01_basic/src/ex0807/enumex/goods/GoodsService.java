...
public class GoodsService{
   ...
   public InsertResult insert(Goods goods){
	   ...
	   //중복체크 
	   if (selectByCode(goods.getCode()) != null) return InsertResult.INSERT_DUPLICATE;
	  
	   //추가 성공
	   goodsArr[count++] = goods; return InsertResult.INSERT_SUCCESS;
   }
