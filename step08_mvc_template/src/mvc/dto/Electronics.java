...
public class Electronics implements Comparable<Electronics> {
	...
	public int compareTo(Electronics o) {
		if (this.getModelPrice() == o.getModelPrice()) {
			return this.getModelNo() - o.getModelNo();
		} else {
			return this.getModelPrice() - o.getModelPrice();
		}
	}
}