...
public interface ElectronicsService {
	...
	/**
	 * 전자제품 등록
	 * @param electronics : List 저장 객체의 개수가 MAX_SIZE를 벗어나면 ElectronicsArrayBoundsException 예외발생
	 ...
	 * 모델번호에 해당하는 전자제품 검색
	 * @param modelNo
	 * @return : 만약 찾는 정보가 없으면 SearchNotFoundException 예외발생
	 ...
	 * @param electronics : 수정전에 모델번호에 해당하는 정보가 있는지를 찾고 없으면 SearchNotFoundException 예외발생
	 ...
	 * @param 모델번호 : 삭제전에 모델번호에 해당하는 정보가 있는지를 찾고 없으면 SearchNotFoundException 예외발생
